...
sleep 1
for spec in "mobile:390x844:mobile.html" "mobile-chat:390x844:mobile-chat.html" "group-chat:390x844:group-chat.html" "group-chat-tablet:900x700:group-chat.html" "tablet-mid:900x700:tablet.html" "tablet-wide:1180x820:tablet.html" "tablet-xwide:1440x900:tablet.html" "tablet-empty:900x700:tablet.html?empty=1" "tablet-empty-wide:1180x820:tablet.html?empty=1" "channels-tab:900x700:tab.html?tab=channels" "channels-follow:900x700:tab.html?tab=channels&follow=1" "contacts-tab:900x700:tab.html?tab=contacts" "contacts-recommend:900x700:tab.html?tab=contacts&ctab=recommend" "contacts-device:900x700:tab.html?tab=contacts&ctab=device" "dynamics-tab:900x700:tab.html?tab=dynamics" "dynamics-tab-mobile:390x844:tab.html?tab=dynamics&mobile=1" "dynamics-long:390x1400:tab.html?tab=dynamics&mobile=1" "attach-panel:390x844:attach-panel.html" "attach-panel-tablet:900x700:attach-panel.html" "emoji-panel:390x844:emoji-panel.html" "emoji-panel-tablet:900x700:emoji-panel.html" "message-menu:390x844:message-menu.html" "message-menu-tablet:900x700:message-menu.html" "voice-recording:390x844:voice-recording.html"  "settings-tab:900x700:tab.html?tab=settings" "settings-mobile:390x844:tab.html?tab=settings&mobile=1" "settings-accessibility:900x700:tab.html?tab=settings&sub=accessibility" "settings-accessibility-mobile:390x844:tab.html?tab=settings&sub=accessibility&mobile=1" "settings-long:390x1400:tab.html?tab=settings&mobile=1" "about-tab:900x700:tab.html?tab=settings&sub=about" "about-mobile:390x844:tab.html?tab=settings&sub=about&mobile=1" "about-long:390x1400:tab.html?tab=settings&sub=about&mobile=1" "contacts-group:900x700:tab.html?tab=contacts" "composer-reply:390x844:composer-reply.html"; do
  IFS=':' read -r name size page <<< "$spec"
  "$CHROME" --no-sandbox --disable-dev-shm-usage --no-zygote \
    --use-gl=swiftshader --disable-vulkan --hide-scrollbars --virtual-time-budget=2500 \
    --window-size="$size" \
    --screenshot="$OUT/$name.png" \
    "http://127.0.0.1:$PORT/$page" >/dev/null 2>&1 || echo "FAIL $name"
  echo "shot $name"
done
for spec in "mobile-dark:390x844:mobile.html?dark=1" "mobile-chat-dark:390x844:mobile-chat.html?dark=1" "group-chat-dark:390x844:group-chat.html?dark=1" "tablet-dark:900x700:tablet.html?dark=1" "tablet-empty-dark:900x700:tablet.html?empty=1&dark=1" "tab-channels-dark:900x700:tab.html?tab=channels&dark=1" "channels-follow-dark:900x700:tab.html?tab=channels&follow=1&dark=1" "tab-contacts-dark:900x700:tab.html?tab=contacts&dark=1" "tab-contacts-recommend-dark:900x700:tab.html?tab=contacts&ctab=recommend&dark=1" "tab-contacts-device-dark:900x700:tab.html?tab=contacts&ctab=device&dark=1" "tab-dynamics-dark:900x700:tab.html?tab=dynamics&dark=1" "tab-dynamics-mobile-dark:390x844:tab.html?tab=dynamics&mobile=1&dark=1" "dynamics-long-dark:390x1400:tab.html?tab=dynamics&mobile=1&dark=1" "emoji-panel-dark:390x844:emoji-panel.html?dark=1" "attach-panel-dark:390x844:attach-panel.html?dark=1" "voice-recording-dark:390x844:voice-recording.html?dark=1" "composer-reply-dark:390x844:composer-reply.html?dark=1"  "settings-tab-dark:900x700:tab.html?tab=settings&dark=1" "settings-mobile-dark:390x844:tab.html?tab=settings&mobile=1&dark=1" "settings-accessibility-dark:900x700:tab.html?tab=settings&sub=accessibility&dark=1" "settings-accessibility-mobile-dark:390x844:tab.html?tab=settings&sub=accessibility&mobile=1&dark=1" "settings-long-dark:390x1400:tab.html?tab=settings&mobile=1&dark=1" "about-tab-dark:900x700:tab.html?tab=settings&sub=about&dark=1" "about-mobile-dark:390x844:tab.html?tab=settings&sub=about&mobile=1&dark=1" "about-long-dark:390x1400:tab.html?tab=settings&sub=about&mobile=1&dark=1" "contacts-group-dark:900x700:tab.html?tab=contacts&dark=1" "message-menu-dark:390x844:message-menu.html?dark=1"; do
  IFS=':' read -r name size page <<< "$spec"
  "$CHROME" --no-sandbox --disable-dev-shm-usage --no-zygote \
    --use-gl=swiftshader --disable-vulkan --hide-scrollbars --virtual-time-budget=2500 \
    --window-size="$size" \
...
for spec in "drawer-mobile:390x844:mobile.html?drawer=1" "drawer-tablet:900x700:tablet.html?drawer=1"; do
  IFS=':' read -r name size page <<< "$spec"
  "$CHROME" --no-sandbox --disable-dev-shm-usage --no-zygote \
    --use-gl=swiftshader --disable-vulkan --hide-scrollbars --virtual-time-budget=2500 \
    --window-size="$size" \
...
for spec in "drawer-mobile-dark:390x844:mobile.html?drawer=1&dark=1" "drawer-tablet-dark:900x700:tablet.html?drawer=1&dark=1"; do
  IFS=':' read -r name size page <<< "$spec"
  "$CHROME" --no-sandbox --disable-dev-shm-usage --no-zygote \
    --use-gl=swiftshader --disable-vulkan --hide-scrollbars --virtual-time-budget=2500 \
    --window-size="$size" \
