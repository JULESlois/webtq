...
const MENU = [
  {label: '相册', icon: 'M4 5h16a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V6a1 1 0 0 1 1-1Z', color: '#FAAD14'},
  {label: '收藏', icon: 'M12 3l2.7 5.5 6.1.9-4.4 4.3 1 6.1-5.4-2.9-5.4 2.9 1-6.1L3.2 9.4l6.1-.9L12 3Z', color: '#1890FF'},
  {label: '文件', icon: 'M6 3h8l5 5v13H6V3Zm7 0v6h6', color: '#1890FF'},
  {label: '钱包', icon: 'M3 7h18v11H3V7Zm0 5h18M7 16h5', color: '#52C41A'},
  {label: '财富小金库', icon: 'M12 3l2.5 5 5.5.8-4 3.9.9 5.5L12 15.9 7.1 18.2l.9-5.5-4-3.9L9.5 8 12 3Z', color: '#1890FF'},
  {label: '会员中心', icon: 'M12 3l3 4.5L20 9l-3.5 4.5L17 20l-5-2.8L7 20l.5-6.5L4 9l5-.5L12 3Z', color: '#EB2F96'},
  {label: '个性装扮', icon: 'M5 4h14v5H5V4Zm0 6h14v5H5v-5Zm0 6h8v4H5v-4Zm11 1v4m-2-2h4', color: '#EB2F96'},
  {label: '免流量', icon: 'M12 3a9 9 0 1 0 9 9c0-1.2-.2-2.3-.7-3.3L12 12V3Zm0 0a9 9 0 0 1 9 9', color: '#52C41A'}
];
        ...
        <div class={styles.header}>
          ...
          <div class={styles.userCard}>
            ...
            <div class={styles.meta}>
              ...
              <div class={styles.vipRow}>
                <span class={styles.vipStars}>★★★★</span>
                <span class={styles.vipLabel}>SVIP7</span>
              </div>
              <div class={styles.sign}>这个人很懒，什么都没留下</div>
            </div>
            <button type="button" class={styles.qrBtn} aria-label="二维码">
              <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round"><rect x="3.5" y="3.5" width="7" height="7" rx="1.2"/><rect x="13.5" y="3.5" width="7" height="7" rx="1.2"/><rect x="3.5" y="13.5" width="7" height="7" rx="1.2"/><path d="M13.5 13.5h3v3h-3z"/><path d="M20.5 13.5h-1M20.5 20.5h-4v-3.5h1.5"/></svg>
            </button>
          </div>
        </div>
